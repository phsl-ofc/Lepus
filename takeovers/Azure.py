...
def init(domain, ARecords, CNAMERecords):
	...
	for entry in CNAMERecords:
		...
		if any(azureSub in CNAME for azureSub in ["azure-api.net", "azurecontainer.io", "azurecr.io", "azuredatalakeanalytics.net", "azuredatalakestore.net", "azurehealthcareapis.com", 
